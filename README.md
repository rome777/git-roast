...
- **회원 탈퇴와 재가입**: 대시보드 맨 아래에서 직접 탈퇴할 수 있습니다. 계정과 분석 기록이 **모두 영구 삭제**되며(공유했던 카드 링크도 함께 사라집니다), **같은 이메일로 언제든 다시 가입**할 수 있습니다. 실행 전에 비밀번호를 다시 확인하고 이메일 주소를 직접 입력하게 해, 세션만 가지고는 계정을 지울 수 없도록 했습니다.
